...
pipeline {
    ...
    parameters {
        string(name: 'SOURCE_BRANCH', defaultValue: 'release/candidate', description: 'Branch to build from')
        choice(name: 'BUILD_TYPE', choices: ['Compatrelease', 'Debug', 'Release'], description: 'Build Type for the Client')
