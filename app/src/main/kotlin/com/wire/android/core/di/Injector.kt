...
object Injector {
     ...
     */
    private val sharedModules: List<Module> = listOf(userModule, sessionModule, assetModule)
    ...
    private val featureModules: List<Module> =
        listOf(launcherModule, welcomeModule, *authenticationModules, conversationsModule, contactModule)
