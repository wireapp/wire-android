...
import com.wire.android.shared.crypto.di.cryptoBoxModule
...
object Injector {
     ...
     */
    private val sharedModules: List<Module> = listOf(userModule, sessionModule, teamModule, assetModule, cryptoBoxModule)
