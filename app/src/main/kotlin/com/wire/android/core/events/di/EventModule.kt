...
val eventModule = module {
    ...
    single { WebSocketConfig("6fe10a0abc76f3d") }
    ...
    single { NotificationRemoteDataSource(get(), get(), get(), get()) }
    ...
    single<EventRepository> { EventDataSource(get(), get(), get(), "6fe10a0abc76f3d") }
