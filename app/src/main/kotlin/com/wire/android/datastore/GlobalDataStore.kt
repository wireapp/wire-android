...
class GlobalDataStore @Inject constructor(@ApplicationContext private val context: Context) {
    ...
    companion object {
        ...
        val MESSAGE_NOTIFICATION_AUTOGENERATED_REPLY = booleanPreferencesKey("message_notification_autogenerated_reply")
    ...
    suspend fun setMessageNotificationAutoGeneratedReply(
        value: Boolean
    ) = context.dataStore.edit {
        it[MESSAGE_NOTIFICATION_AUTOGENERATED_REPLY] = value
    }

    fun getMessageNotificationAutoGeneratedReply(
        default: Boolean
    ) = getBooleanPreference(MESSAGE_NOTIFICATION_AUTOGENERATED_REPLY, default)
}
