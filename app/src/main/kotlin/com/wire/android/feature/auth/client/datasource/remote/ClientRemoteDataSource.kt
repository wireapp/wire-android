...
class ClientRemoteDataSource(override val networkHandler: NetworkHandler, private val clientApi: ClientApi) : ApiService() {

    suspend fun registerNewClient(clientRequest: ClientRegistrationRequest) : Either<Failure, ClientResponse> =
        request { clientApi.registerClient(clientRequest) }
}
