...
class ClientRemoteDataSource(
    ...
    suspend fun registerNewClient(authorizationToken: String, client: Client): Either<Failure, ClientResponse> = request {

        val clientRegistrationRequest = clientMapper.toClientRegistrationRequest(client)
