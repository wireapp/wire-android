        ...
        activity?.let {
            if (conversationListItem != null && conversationListItem.conversation.name != null)
                navigator.conversation.openConversationScreen(
                    it,
                    conversationIdValue = conversationListItem.conversation.id.value,
                    conversationDomain = conversationListItem.conversation.id.domain,
                    conversationTitle = conversationListItem.conversation.name
                )
        }
    }
