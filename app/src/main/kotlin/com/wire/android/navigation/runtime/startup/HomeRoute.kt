...
/**
 * Navigation 3 contract for the root of an authenticated session.
 *
 * [ROUTE_ID] deliberately preserves the former generated base route to keep analytics stable.
 */
@Serializable
