...
@Inject constructor(
    ...
    private val autoGeneratedReplyProvider: AutoGeneratedReplyProvider
) {
    ...
    private suspend fun addNotifications(newNotifications: List<LocalNotification>, userId: QualifiedID, userName: String) {
     ...
     */
    private suspend fun getConversationNotification(
        ...
        val updatedMessageStyle = activeNotifications
            ...
            ?: return null
        val autoGeneratedReply = autoGeneratedReplyProvider.getAutoGeneratedReply()
                            ...
                            is NotificationMessage.Comment -> {
                                ...
                                addAction(
                                    getActionReply(
                                        ...
                                        userIdString,
                                        isAppLocked,
                                        allowGeneratedReply = autoGeneratedReply
                                    )
                                )
                            }
    ...
    companion object {
        ...
        fun updateNotificationAfterQuickReply(
            ...
            val notification = setUpNotificationBuilder(context, userId, true).apply {
                ...
                addAction(getActionReply(context, conversationId, userIdString, false, autoGenerateReply))
