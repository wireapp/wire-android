...
interface PreKeyRepository {
     ...
     */
    suspend fun preKeysOfClientsByQualifiedUsers(qualifiedIdsMap: Map<QualifiedId, List<String>>): Either<Failure, List<QualifiedUserPreKeyInfo>>
    ...
    suspend fun preKeysOfClientsByUsers(contactIdsMap: Map<String, List<String>>): Either<Failure, List<UserPreKeyInfo>>
}
