    ...
    with(viewModel) {
        ...
        CreateAccountEmailContent(
            ...
            text = CreateAccountEmailText(
                ...
                domainBlockedError = stringResource(R.string.create_account_email_domain_blocked_error),
                invalidEmailError = stringResource(R.string.create_account_email_invalid_error),
            ...
            termsText = CreateAccountEmailTermsText(
                ...
                description = stringResource(R.string.create_account_email_terms_dialog_text),
                cancelLabel = stringResource(R.string.label_cancel),
                continueLabel = stringResource(R.string.label_continue),
                viewPolicyLabel = stringResource(R.string.create_account_email_terms_dialog_view_policy),
            ),
