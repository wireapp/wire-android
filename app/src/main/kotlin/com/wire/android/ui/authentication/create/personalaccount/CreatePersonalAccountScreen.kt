...
@Composable
fun CreatePersonalAccountScreen(viewModel: CreatePersonalAccountViewModel) {
    val scope = rememberCoroutineScope()
    Column(modifier = Modifier.fillMaxSize()) { // needed for the transition animations to work properly
        Navigator(screen = CreatePersonalAccountNavigationItem.Overview(viewModel)) { navigator ->
