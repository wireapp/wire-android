...
internal fun CreateAccountUsernameRouteScreen(
    ...
    CreateAccountUsernameContent(
        ...
        text = CreateAccountUsernameText(
            ...
            usernamePlaceholder = stringResource(R.string.create_account_username_placeholder),
            usernameLabel = stringResource(R.string.create_account_username_label),
            usernameDescription = stringResource(R.string.create_account_username_description),
            usernameTakenError = stringResource(R.string.create_account_username_taken_error),
