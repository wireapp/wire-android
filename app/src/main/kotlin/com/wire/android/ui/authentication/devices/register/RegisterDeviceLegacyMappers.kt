...
import com.wire.android.ui.authentication.devices.common.requireWireSessionId
import com.wire.navigation.WireNavEntryId

internal fun SessionBackedAuthenticationNavArgs.toRegisterDeviceRoute(
    entryId: WireNavEntryId = WireNavEntryId.random(),
) = RegisterDeviceRoute(
    sessionId = requireWireSessionId(),
    entryId = entryId,
)
