...
class OngoingCallActivity : CallActivity() {
    private val servicesManager by lazy(LazyThreadSafetyMode.NONE) {
        metroGraph.servicesManager
    }
    private val callNotificationManager by lazy(LazyThreadSafetyMode.NONE) {
        metroGraph.callNotificationManager
    }
