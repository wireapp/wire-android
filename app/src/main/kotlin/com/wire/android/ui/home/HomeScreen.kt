...
import com.wire.android.ui.drawer.HomeDrawer
...
fun HomeScreen(
    ...
    HomeContent(
        ...
        navigateToItem = {
            if (it.isExternalRoute()) {
                CustomTabsHelper.launchUrl(context, it.route)
            } else {
                    ...
                    ModalBottomSheetLayout(
                        ...
                        CollapsingTopBarScaffold(
                            ...
                            topBarCollapsing = {
                                ...
                                val shouldBeVisible = currentDestination is AllConversationScreenDestination ||
                                        currentDestination is ConversationBottomSheetDestination
                                if (shouldBeVisible) {
                                    SearchTopBar(
...
//                            }
                            ...
                            floatingActionButton = {
                                val currentDestination = navHostController.currentDestinationAsState().value
                                val bottomBarDestinations = BottomBarDestination.values().map { it.direction.route }
                                val shouldBeVisible = currentDestination?.let {
                                    currentDestination.route in bottomBarDestinations && !searchBarState.isSearchActive
                                } ?: false
                                AnimatedVisibility(
...
//        else -> homeNavigationItem.toBottomNavigationItemData(0)
//    }
//}
