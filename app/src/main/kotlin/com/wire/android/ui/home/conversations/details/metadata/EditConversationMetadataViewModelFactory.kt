...
@Inject
class EditConversationMetadataViewModelFactory(
    private val dispatcher: DispatcherProvider,
    private val observeConversationDetails: ObserveConversationDetailsUseCase,
    private val renameConversation: RenameConversationUseCase,
) {
    fun create(args: EditConversationNameNavArgs): EditConversationMetadataViewModel = EditConversationMetadataViewModel(
        editConversationNameNavArgs = args,
