...
@Inject
class UpdateAppsAccessViewModelFactory(
    ...
    fun create(args: UpdateAppsAccessNavArgs): UpdateAppsAccessViewModel = UpdateAppsAccessViewModel(
        updateAppsAccessNavArgs = args,
