...
@Inject
class ConversationFoldersViewModelFactory(
    private val observeUserFoldersUseCase: ObserveUserFoldersUseCase,
) {
    fun create(args: ConversationFoldersStateArgs): ConversationFoldersVMImpl = ConversationFoldersVMImpl(
        args = args,
        observeUserFoldersUseCase = observeUserFoldersUseCase,
    )
}
