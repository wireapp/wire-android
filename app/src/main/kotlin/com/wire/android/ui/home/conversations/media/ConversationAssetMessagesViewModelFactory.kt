...
@Inject
class ConversationAssetMessagesViewModelFactory(
    ...
    fun create(args: ConversationMediaNavArgs): ConversationAssetMessagesViewModel = ConversationAssetMessagesViewModel(
        conversationMediaNavArgs = args,
