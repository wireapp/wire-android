...
sealed class MessageClickActions {
    ...
    open val onThreadClicked: (rootMessageId: String, threadId: String, rootMessageSelfDeletionDurationMillis: Long?) -> Unit = { _, _, _ -> }
    ...
    data class Content(
        ...
        override val onThreadClicked: (rootMessageId: String, threadId: String, rootMessageSelfDeletionDurationMillis: Long?) -> Unit = { _, _, _ -> },
