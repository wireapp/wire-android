...
fun ConversationsEmptyContent(
    ...
    EmptyListContent(
        ...
        modifier = modifier,
        footer = {
            EmptyContentFooter(currentFilter = filter, onBrowseChannels = onBrowseChannels)
        }
    )
}

@Composable
private fun EmptyContentFooter(currentFilter: ConversationFilter, onBrowseChannels: () -> Unit) {
...
fun PreviewAllConversationsEmptyContent() = WireTheme {
    ConversationsEmptyContent(filter = ConversationFilter.All, onBrowseChannels = {})
}

@PreviewMultipleThemes
@Composable
fun PreviewChannelsConversationsEmptyContent() = WireTheme {
    ConversationsEmptyContent(filter = ConversationFilter.Channels, onBrowseChannels = {})
}

@PreviewMultipleThemes
@Composable
fun PreviewFavoritesConversationsEmptyContent() = WireTheme {
    ConversationsEmptyContent(filter = ConversationFilter.Favorites, onBrowseChannels = {})
}

@PreviewMultipleThemes
@Composable
fun PreviewGroupConversationsEmptyContent() = WireTheme {
    ConversationsEmptyContent(filter = ConversationFilter.Groups, onBrowseChannels = {})
}
...
fun PreviewOneOnOneConversationsEmptyContent() = WireTheme {
    ConversationsEmptyContent(
        filter = ConversationFilter.OneOnOne,
        domain = "wire.com",
        onBrowseChannels = {},
    )
}
