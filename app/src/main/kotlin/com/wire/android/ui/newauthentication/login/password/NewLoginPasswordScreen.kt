...
internal fun NewLoginPasswordRouteScreen(
    ...
    NewLoginPasswordContent(
        ...
        sharedText = NewLoginPasswordSharedText(
            ...
            proxyIdentifierLabel = stringResource(R.string.login_proxy_identifier_label),
            proxyIdentifierPlaceholder = stringResource(R.string.login_user_identifier_placeholder),
            proxyPasswordLabel = stringResource(R.string.label_proxy_password),
