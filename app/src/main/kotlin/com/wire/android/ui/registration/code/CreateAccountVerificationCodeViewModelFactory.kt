...
@Inject
class CreateAccountVerificationCodeViewModelFactory(
    ...
    fun create(args: CreateAccountDataNavArgs): CreateAccountVerificationCodeViewModel = CreateAccountVerificationCodeViewModel(
