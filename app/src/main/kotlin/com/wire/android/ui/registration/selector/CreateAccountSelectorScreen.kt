    ...
    LegacyRegistrationSelectorContent(
        text = LegacyRegistrationSelectorText(
            ...
            team = LegacyRegistrationSelectorText.Card(
                stringResource(R.string.create_account_selector_team_title), stringResource(R.string.create_account_selector_team_subtitle),
                listOf(stringResource(R.string.create_account_selector_team_highlight_one), stringResource(R.string.create_account_selector_team_highlight_two)), stringResource(R.string.create_team_title),
            ),
            personal = LegacyRegistrationSelectorText.Card(
                stringResource(R.string.create_account_selector_personal_title), stringResource(R.string.create_account_selector_personal_subtitle),
                listOf(stringResource(R.string.create_account_selector_personal_highlight_one), stringResource(R.string.create_account_selector_personal_highlight_two)), stringResource(AuthenticationR.string.create_personal_account_title),
            ),
        ),
        checkIcon = painterResource(CommonR.drawable.ic_check_circle),
        positiveColor = colorsScheme().positive,
        serverTitle = { if (viewModel.serverConfig.isOnPremises) ServerTitle(viewModel.serverConfig, MaterialTheme.wireTypography.body01) },
        onNavigateBack = onNavigateBack,
        onPersonalAccountCreationClicked = { onPersonalAccountCreation(CreateAccountDataNavArgs(customServerConfig = viewModel.serverConfig, userRegistrationInfo = UserRegistrationInfo(viewModel.email))) },
