...
sealed class OtherUserProfileInfoMessageType(override val uiText: UIText) : SnackBarMessage {
    // connection
    object SuccessConnectionSentRequest : OtherUserProfileInfoMessageType(UIText.StringResource(commonR.string.connection_request_sent))
    object ConnectionRequestError : OtherUserProfileInfoMessageType(UIText.StringResource(commonR.string.connection_request_sent_error))
    object SuccessConnectionAcceptRequest : OtherUserProfileInfoMessageType(
        UIText.StringResource(commonR.string.connection_request_accepted)
    )
    object ConnectionAcceptError : OtherUserProfileInfoMessageType(UIText.StringResource(commonR.string.connection_request_accept_error))
    object SuccessConnectionCancelRequest : OtherUserProfileInfoMessageType(
        UIText.StringResource(commonR.string.connection_request_canceled)
    )
    object ConnectionCancelError : OtherUserProfileInfoMessageType(UIText.StringResource(commonR.string.connection_request_cancel_error))
    object ConnectionIgnoreError : OtherUserProfileInfoMessageType(UIText.StringResource(commonR.string.connection_request_ignore_error))
    ...
    object UnblockingUserOperationError : OtherUserProfileInfoMessageType(UIText.StringResource(commonR.string.error_unblocking_user))
