...
sealed class ImageUtil private constructor() {
    ...
    companion object {
        ...
        @Suppress("MagicNumber")
        private fun qualityForSizeClass(sizeClass: ImageSizeClass): Int {
            return when (sizeClass) {
        ...
        /**
         * Resamples, downscales and normalizes rotation of an image based on it's intended [ImageSizeClass] use.
         * Works on JPEGS Only.
         *
        ...
        fun resample(byteArray: ByteArray, sizeClass: ImageSizeClass): ByteArray {
            ...
            if (shouldScale(bitmap, targetDimension)) {
                ...
                resizedImage.compress(Bitmap.CompressFormat.JPEG, qualityForSizeClass(sizeClass), output)
