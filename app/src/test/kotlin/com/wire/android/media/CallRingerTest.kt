...
class CallRingerTest {
    ...
    @Test
    fun givenNormalAudioMode_whenCallRingerIsConstructed_thenNormalAudioModeIsPreserved() {
    ...
    @Test
    fun givenSpeakerphoneCommunicationOutput_whenCallRingerIsConstructed_thenOutputIsPreserved() {
