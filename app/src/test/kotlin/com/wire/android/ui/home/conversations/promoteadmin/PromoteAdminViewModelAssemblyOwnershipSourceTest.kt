...
class PromoteAdminViewModelAssemblyOwnershipSourceTest {
    ...
    fun promoteAdminFactoryIsFeatureOwnedAndInstalledOnceByAppComposition() {
        ...
        assertEquals(
            1,
            Regex("\\bPromoteAdminManualViewModelFactoryMetroBindings::class\\b")
                .findAll(sessionGraph)
                .count(),
        )
        assertTrue(auxEntries.contains("viewModel = promoteAdminViewModel(it.toViewModelArgs())"))
    }
