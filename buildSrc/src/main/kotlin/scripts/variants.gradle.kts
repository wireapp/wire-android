...
object Default {
    val BUILD_FLAVOR: String = System.getenv("unitTestFlavor") ?: System.getenv("FLAVOR") ?: ProductFlavors.Dev.buildName
    val BUILD_TYPE = System.getenv("unitTestBuildType") ?: System.getenv("BUILD_TYPE") ?: BuildTypes.DEBUG
