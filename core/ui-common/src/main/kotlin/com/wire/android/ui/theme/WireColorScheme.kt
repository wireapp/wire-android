...
data class WireColorScheme(
    ...
    val callingParticipantNameBackground: Color,
    val callingParticipantNameText: Color,
    val callingParticipantNameConnectingText: Color,
    val callingParticipantError: Color,
...
private val LightWireColorScheme = WireColorScheme(
    ...
    inverseSurface = WireColorPalette.Gray95, inverseOnSurface = Color.White,
    ...
    callingParticipantNameBackground = Color.Black,
    callingParticipantNameText = Color.White,
    callingParticipantNameConnectingText = WireColorPalette.Gray60,
    callingParticipantError = WireColorPalette.DarkRed500,
