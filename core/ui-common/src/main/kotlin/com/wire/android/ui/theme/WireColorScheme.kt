...
data class WireColorScheme(
    ...
    val primaryButtonFocused: Color,
    ...
    val secondaryButtonFocused: Color,
    ...
    val tertiaryButtonFocused: Color,
...
private val LightWireColorScheme = WireColorScheme(
    ...
    primaryButtonFocused = WireColorPalette.LightBlue700,
    ...
    secondaryButtonFocused = LightBlue50,
    ...
    tertiaryButtonFocused = LightBlue50,
...
private val DarkWireColorScheme = WireColorScheme(
    ...
    primaryButtonFocused = WireColorPalette.DarkBlue300,
    ...
    secondaryButtonFocused = WireColorPalette.DarkBlue800,
    ...
    tertiaryButtonFocused = WireColorPalette.DarkBlue800,
