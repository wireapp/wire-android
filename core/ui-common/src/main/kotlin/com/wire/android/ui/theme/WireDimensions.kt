...
data class WireDimensions(
    ...
    val radioButtonInnerDotSize: Dp,
    val radioButtonSelectedBorderWidth: Dp,
    val radioButtonUnselectedBorderWidth: Dp,
    val radioButtonFocusBorderWidth: Dp,
    val radioButtonFocusGapWidth: Dp,
    val radioButtonSelectedFocusGapWidth: Dp,
    // Message
    val messageImageMinWidth: Dp,
...
private val DefaultPhonePortraitWireDimensions: WireDimensions = WireDimensions(
    ...
    radioButtonSize = 22.dp,
    radioButtonInnerDotSize = 10.dp,
    radioButtonSelectedBorderWidth = 2.dp,
    radioButtonUnselectedBorderWidth = 3.dp,
    radioButtonFocusBorderWidth = 2.dp,
    radioButtonFocusGapWidth = 1.dp,
    radioButtonSelectedFocusGapWidth = 2.dp,
