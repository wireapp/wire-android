...
enum class SupportPage(
    ...
    MLS("mls", R.string.url_system_message_learn_more_about_mls),
    ...
    companion object {
        fun fromHardcodedUrlRes(@StringRes hardcodedUrlRes: Int): SupportPage? =
            values().firstOrNull { it.hardcodedUrlRes == hardcodedUrlRes }
    }
}
