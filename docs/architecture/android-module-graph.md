...
Audited app production-file counts are: conversations **147**, message composer **40**,
...
**142** production files and **55** unit-test files. Its **25** Crowdin-tracked `strings.xml` files span
**25** values directories and contain **933** string definitions, including the exact
