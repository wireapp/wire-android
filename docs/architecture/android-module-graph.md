...
**Last verified:** 2026-08-24, `chore/android-modularization`, baseline HEAD `ce5ad447d`.
...
Audited app production-file counts are: conversations **145**, message composer **39**,
...
**27**. The strict app conversations directory has **54** unit tests and **1** Android
 test; **68** files import app `R`, **341** distinct resource-alias `R.type.name`
IDs occur there, and **3** files use `BuildConfig`. `:features:conversation` now owns
**145** production files and **57** unit-test files. Its **25** Crowdin-tracked `strings.xml` files span
**25** values directories and contain **992** string definitions, including the exact
