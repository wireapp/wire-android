...
Audited app production-file counts are: conversations **172**, message composer **40**,
...
**114** production files and **43** unit-test files. Its **25** Crowdin-tracked `strings.xml` files span
