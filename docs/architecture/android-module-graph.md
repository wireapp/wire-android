...
Audited app production-file counts are: conversations **168**, message composer **40**,
...
**118** production files and **45** unit-test files. Its **25** Crowdin-tracked `strings.xml` files span
