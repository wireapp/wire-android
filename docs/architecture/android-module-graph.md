...
Audited app production-file counts are: conversations **158**, message composer **40**,
...
**130** production files and **49** unit-test files. Its **25** Crowdin-tracked `strings.xml` files span
