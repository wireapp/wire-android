...
Audited app production-file counts are: conversations **149**, message composer **40**,
...
**27**. The strict app conversations directory has **54** unit tests and **1** Android
 test; **71** files import app `R`, **348** distinct resource-alias `R.type.name`
IDs occur there, and **3** files use `BuildConfig`. `:features:conversation` now owns
**140** production files and **53** unit-test files. Its **25** Crowdin-tracked `strings.xml` files span
**25** values directories and contain **911** string definitions, including the exact
