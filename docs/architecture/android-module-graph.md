...
Audited app production-file counts are: conversations **152**, message composer **40**,
...
**137** production files and **53** unit-test files. Its **25** Crowdin-tracked `strings.xml` files span
