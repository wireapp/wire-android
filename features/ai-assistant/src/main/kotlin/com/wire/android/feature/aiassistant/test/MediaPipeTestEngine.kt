...
class MediaPipeTestEngine @Inject constructor(
    ...
    override suspend fun runHealthCheck(modelPath: String): AiModelHealthCheckResult =
        withContext(Dispatchers.IO) {
            ...
            if (!descriptor.isSupportedByMediaPipeLlmInference()) {
    ...
    private companion object {
        ...
        private fun AiModelDescriptor.isSupportedByMediaPipeLlmInference(): Boolean =
            !repositoryId.contains("gemma-3n", ignoreCase = true) &&
                    !artifactPath.contains("gemma-3n", ignoreCase = true)
    }
}
