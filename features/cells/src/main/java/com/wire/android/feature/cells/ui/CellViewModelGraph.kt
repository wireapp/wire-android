...
interface CellViewModelGraph : MetroViewModelGraph {
    val cellViewModelFactory: CellViewModelFactory
    val createFileViewModelFactory: CreateFileViewModelFactory
    val createFolderViewModelFactory: CreateFolderViewModelFactory
    val renameNodeViewModelFactory: RenameNodeViewModelFactory
    val moveToFolderViewModelFactory: MoveToFolderViewModelFactory
    val addRemoveTagsViewModelFactory: AddRemoveTagsViewModelFactory
    val versionHistoryViewModelFactory: VersionHistoryViewModelFactory
    val publicLinkViewModelFactory: PublicLinkViewModelFactory
    val publicLinkExpirationScreenViewModelFactory: PublicLinkExpirationScreenViewModelFactory
    val publicLinkPasswordScreenViewModelFactory: PublicLinkPasswordScreenViewModelFactory
