...
object EditGuestAccessManualViewModelFactoryGroup
...
@Composable
fun editGuestAccessViewModel(
    args: EditGuestAccessNavArgs,
): EditGuestAccessViewModel =
    wireAssistedMetroViewModel<EditGuestAccessViewModel, EditGuestAccessManualViewModelFactory> { _ ->
        editGuestAccessViewModel(args)
    }
