...
object GroupConversationDetailsManualViewModelFactoryGroup
...
@Composable
fun groupConversationDetailsViewModel(
    args: GroupConversationDetailsNavArgs,
): GroupConversationDetailsViewModel =
    wireAssistedMetroViewModel<GroupConversationDetailsViewModel, GroupConversationDetailsManualViewModelFactory> { _ ->
        groupConversationDetailsViewModel(args)
    }
