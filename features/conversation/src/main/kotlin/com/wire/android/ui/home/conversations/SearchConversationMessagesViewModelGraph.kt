...
object SearchConversationMessagesManualViewModelFactoryGroup

@Composable
fun searchConversationMessagesViewModel(
    args: SearchConversationMessagesNavArgs,
): SearchConversationMessagesViewModel =
    wireAssistedMetroViewModel<
        SearchConversationMessagesViewModel,
        SearchConversationMessagesManualViewModelFactory,
    > { _ ->
        searchConversationMessagesViewModel(args)
    }
