...
import com.wire.android.feature.meetings.navigation.NewMeetingNavGraph
...
@Destination<NewMeetingNavGraph>(
    wrappers = [WaitUntilTransitionEndsWrapper::class, TabletDialogWrapper::class],
)
internal annotation class WireNewMeetingDestination(
