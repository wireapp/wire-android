...
data class LoginEmailState(
    ...
    val isLoading: Boolean
        get() = flowState is LoginEmailFlowState.Loading

    val isSuccess: Boolean
        get() = flowState is LoginEmailFlowState.Success

    val isInvalidCredentials: Boolean
        get() = flowState is LoginEmailFlowState.Error && flowState.type is LoginEmailError.InvalidCredentials

    val isSecondFactorRequired: Boolean
        get() = secondFactorVerificationCode.isCodeInputNecessary

    val isSecondFactorInvalid: Boolean
        get() = secondFactorVerificationCode.isCurrentCodeInvalid

    val secondFactorCode: String
        get() = secondFactorVerificationCode.code

    val isSecondFactorCodeComplete: Boolean
        get() = secondFactorVerificationCode.code.length == secondFactorVerificationCode.codeLength

    val secondFactorEmail: String
        get() = secondFactorVerificationCode.emailUsed
}
...
/**
 * One-shot login actions for platform hosts.
 *
