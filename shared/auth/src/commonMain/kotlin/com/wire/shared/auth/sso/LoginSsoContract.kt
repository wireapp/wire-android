...
/**
 * Platform-neutral state for the SSO login screen.
 */
data class LoginSsoState(
    ...
    val isLoading: Boolean
        get() = flowState is LoginSsoFlowState.Loading

    val isSuccess: Boolean
        get() = flowState is LoginSsoFlowState.Success

    val isError: Boolean
        get() = flowState is LoginSsoFlowState.Error
}
...
sealed interface LoginSsoEffect {
    /**
     * The platform layer should open [url] and route the callback back as an intent.
     */
    data class OpenUrl(
        val url: String,
