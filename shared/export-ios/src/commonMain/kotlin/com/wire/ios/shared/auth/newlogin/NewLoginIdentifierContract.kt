...
/**
 * Swift-facing state for the first new-login screen where the user enters an email or SSO code.
 *
 * This mirrors the Android new-login state without exposing Android, Compose navigation,
 * SavedStateHandle, or Kalium-specific error types.
 */
