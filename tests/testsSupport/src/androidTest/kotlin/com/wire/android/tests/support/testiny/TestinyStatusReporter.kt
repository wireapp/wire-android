...
/**
 * Writes Testiny progress messages to the same output streams CI already collects for UI tests.
 */
object TestinyStatusReporter {
    ...
    private fun emit(message: String) {
        ...
        runCatching {
            // sendStatus can fail outside instrumentation; logging should stay best-effort.
