...
node("Job_distributor") {
    ...
    def secrets = [
            ...
            [envVar: 'SOCKS_PROXY_PASSWORD', secretRef: 'op://QA automation/SOCKS_PROXY_PASSWORD/password'],
            ...
            [envVar: 'TESTINY_API_KEY', secretRef: 'op://QA automation/TESTINY_API_KEY_ANDROID/password'],
