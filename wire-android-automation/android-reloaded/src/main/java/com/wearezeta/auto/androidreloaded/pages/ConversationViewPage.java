...
public class ConversationViewPage extends AndroidPage {
    ...
    @AndroidFindBy(xpath = "//android.view.View[@content-desc='Image message']/following-sibling::*[@class='android.widget.Button']")
    ...
    @AndroidFindBy(xpath = "//android.view.View[@content-desc='Image message']")
    ...
    public boolean isConfirmationAlertVisible(String alertText) {
        return waitUntilElementVisible(getDriver().findElement(By.xpath(confirmationAlert.apply(alertText))));
    }
