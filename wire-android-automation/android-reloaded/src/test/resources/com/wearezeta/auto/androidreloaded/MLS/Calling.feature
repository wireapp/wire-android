...
Feature: Calling
  ...
  Scenario Outline: I want to initiate an MLS 1:1 conversation audio/video call
    ...
    And I see <Member1> in ongoing 1:1 call
    And User <Member1> verifies to send and receive audio
    # TC-8231 - I want to initiate a MLS 1:1 conversation video call
  ...
  @TC-8243 @TC-8233 @MLS @MLSCalling
  Scenario Outline: I want to receive an MLS 1:1 conversation audio/video call
    ...
    And I unmute myself
    And User <Member1> verifies to send and receive audio
    # TC-8233 - I want to receive a MLS 1:1 conversation video call
    When I turn camera on
    And Users <Member1> switches video on
  ...
  Scenario Outline: I want to initiate an MLS group conversation audio/video call
    ...
    # TC-8227 - I want to have a MLS conversation call with a video streams
    When I turn camera on
  ...
  Scenario Outline: I want to receive an MLS group conversation audio/video call
    ...
    And Users <TeamOwner>,<Member2>,<Member3> switches video on
    And I wait for 5 seconds
    # TC-8234 - I want to verify CBR traffic when in a MLS group call
...
#  TC-8226	I want to stay on a call in MLS conversation while receiving a call from other clients	No	Medium

#  TC-8228	I want to see participant drop when they get removed from the team during a group call	No	Medium
#  TC-8229	I want to see bad connection indicator for call participants who have a bad network condition	No	Medium
#  TC-8230	I want to see bad connection indicator for myself when I have a bad network condition during call	No	Medium
#
#  TC-8237	I want to see shared screen during MLS group call	No	Medium
#  TC-8238	I want to see shared screen during MLS 1:1 call	No	Medium
