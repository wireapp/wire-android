...
Feature: Migration
  ...
  @TC-4778 @TC-4786 @TC-4787 @TC-4784
  Scenario Outline: I want to see my message history from proteus after migrating group to MLS
    ...
    # TC-4786 - I want to see a system message that migration to MLS has started
    Then I see system message "<MigrationStart>" in conversation view
    # TC-4787 - I want to see a system message that migration to MLS has ended
...
#    And I see Group State status is "ESTABLISHED" in group details page
    And I close the group conversation details through X icon
    # TC-4784 - I want to continue sending and receiving messages after migration to MLS
  ...
  Scenario Outline: I want to see replies and edited messages displayed correctly from proteus conversation after migration to MLS
    ...
    And I see the message "<Message3>" as a reply to message "<Message>" in conversation view
    #  TC-4781 - I want to edit a message that was sent before MLS migration
    ...
    # TC-4780 - I want to reply to a message that was sent before MLS migration
...
#    And I see Group State status is "ESTABLISHED" in group details page
  ...
  Scenario Outline: I should not be dropped from a call that started before migration while migration to MLS is happening
    ...
    # And User <TeamOwner> adds 1 2FA device
    And <TeamOwner> starts 2FA instance using chrome
    And User <TeamOwner> calls <ConversationName>
    Then I see ongoing group call
    And I see user <TeamOwner> in ongoing group call
    And User <TeamOwner> verifies to send and receive audio
...
#  TC-4789	I want to send and receive messages when my team has migrated to MLS and I am in a group conversation with a team that is on proteus	No	Medium

#  TC-4790	I want to log in on a new client after my conversations were migrated to MLS and exchange messages	No	Medium
#  TC-4791	I want to migrate to MLS on a client that has been inactive for >28 days	No	Medium
#  TC-4792	I want to import a backup created before MLS migration