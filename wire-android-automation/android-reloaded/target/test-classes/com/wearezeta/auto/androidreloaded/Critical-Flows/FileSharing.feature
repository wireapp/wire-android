...
#ToDo: Commented steps will be uncommented when the crash caused by tap play button is fixed
#  And I see the time played in the audio file is -:--
#  When I tap play button on the audio file
#  And I wait for 10 seconds
#  And I tap pause button on the audio file
#  Then I see the time played in the audio file is not -:--
