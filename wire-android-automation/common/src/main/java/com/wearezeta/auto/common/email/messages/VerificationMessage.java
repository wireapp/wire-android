...
public class VerificationMessage extends WireMessage {

    public static final Timedelta ACTIVATION_TIMEOUT = Timedelta.ofSeconds(90); // seconds

    public VerificationMessage(String msg) throws Exception {
        super(msg);
    }
    ...
    public static final String MESSAGE_PURPOSE = "SecondFactorVerification";
